                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('admin.update.password') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control @error('old_password') is-invalid @enderror mb-2" name="old_password" id="old_password" autocomplete="off">
                                @error('old_password')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control @error('new_password') is-invalid @enderror mb-2" name="new_password" id="new_password" autocomplete="off">
                                @error('new_password')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
